...
OsuSongBrowser2::OsuSongBrowser2(Osu *osu) : OsuScreenBackable(osu)
{
	...
	*/
	...
	m_scoreBrowser->setScrollResistance((m_osu->isInVRMode() || Environment::getOS == Environment::OS::OS_HORIZON) ? convar->getConVarByName("ui_scrollview_resistance")->getInt() : 15); // a bit shitty this check + convar, but works well enough
	...
	m_songBrowser->setScrollResistance((m_osu->isInVRMode() || Environment::getOS == Environment::OS::OS_HORIZON) ? convar->getConVarByName("ui_scrollview_resistance")->getInt() : 15); // a bit shitty this check + convar, but works well enough
